...
public class TutorialActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		thumb1View.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				zoomImageFromThumb(thumb1View, R.drawable.position);
			}
		});
		...
		thumb2View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb2View, R.drawable.controls);
			}
		});
		...
		thumb3View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb3View, R.drawable.buttons);
			}
		});
		...
		thumb4View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb4View, R.drawable.tiltleft);
			}
		});
		...
		thumb5View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb5View, R.drawable.tiltright);
			}
		});
		...
		thumb6View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb6View, R.drawable.tiltdown);
			}
		});
		...
		thumb7View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb7View, R.drawable.tiltup);
			}
		});
		...
		thumb8View.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				zoomImageFromThumb(thumb8View, R.drawable.simulatebutton);
			}
		});
	...
	Button.OnClickListener faqButton = new Button.OnClickListener() {
		...
		public void onClick(View v) {
			Uri uri = Uri
					.parse("http://www.comp.nus.edu.sg/~bhojan/gameui/faq.html");
	...
	Button.OnClickListener demoVideoButton = new Button.OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			Uri uri = Uri.parse("https://www.youtube.com/watch?v=EXr10ESxLyo");
			Intent intent = new Intent(Intent.ACTION_VIEW, uri);
			startActivity(intent);
		}
	};
