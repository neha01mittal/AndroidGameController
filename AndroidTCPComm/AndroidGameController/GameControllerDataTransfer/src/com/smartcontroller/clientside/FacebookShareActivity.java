...
public class FacebookShareActivity extends FragmentActivity {
	...
	private FacebookDialog.ShareDialogBuilder createShareDialogBuilder() {
		return new FacebookDialog.ShareDialogBuilder(this)
				.setName("Smart Controller")
				.setDescription(
						"The 'SmartController' application lets you play all kinds of PC games using your smartphone")
				.setLink("http://www.strikingly.com/smartcontroller" +
						"").setCaption("Smart Gamers' Smart Choice.");
	}
	...
	private void showPickerFragment(PickerFragment<?> fragment) {
		fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
			...
			public void onError(PickerFragment<?> pickerFragment,
				...
				Toast toast = Toast.makeText(FacebookShareActivity.this,
