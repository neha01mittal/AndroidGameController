...
public class SingletonBluetooth {
    ...
    private class ConnectBTThread extends Thread {
        ...
        public void run() {
           ...
           // mBluetoothAdapter.cancelDiscovery();
            ...
            try {
    			...
    			Log.d("BTManagement", "Trying Socket Connection with " + mmDevice.getName());
                mmSocket.connect();                
                ...
                while(bRun) {
                	//Log.d("BTManagement", "Connected with" + mmDevice.getName());
                	manageConnection();
                }
        ...
        private void manageConnection() {
			...
			//Log.d("BTManagement", "I am in manage Connected socket function");

			if(commandToSend != null) {
				try {
						Log.d("BluetoothManagement", "Sending: " + commandToSend + " "
