...
public class TiltLeftActivity extends Activity {

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tiltleft);
		long time1= System.currentTimeMillis();
		
		while(true) {
			if(System.currentTimeMillis()-time1>5000) {
				Intent k = new Intent(TiltLeftActivity.this, TiltRightActivity.class);
				startActivity(k);
			}
		}
	}
